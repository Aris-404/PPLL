...
<head>
  ...
  <meta
    content="Professional Make Up & Beauty Care Website Template"
    name="description" />
      ...
      <div class="row">
        <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
          <div class="d-inline-flex align-items-center">
            ...
            <span class="text-white">|</span>
            <a class="text-white pl-3" href="">Contact</a>
          </div>
        </div>
          ...
          <div class="owl-carousel testimonial-carousel">
            <div class="text-center">
              ...
              <h4 class="font-weight-light mb-4">
                Saya benar-benar jatuh cinta dengan produk GlamUp!
                Foundation-nya ringan tapi tahan lama, dan hasilnya membuat
                kulit saya tampak segar sepanjang hari.
              </h4>
              <img
            ...
            <div class="text-center">
              <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
              <h4 class="font-weight-light mb-4">
                Layanan pelanggan GlamUp luar biasa! Saya mendapatkan
                rekomendasi produk yang sesuai dengan jenis kulit saya, dan
                hasilnya memuaskan sekali.
              </h4>
              <img
                class="img-fluid mx-auto mb-3"
            ...
            <div class="text-center">
              <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
              <h4 class="font-weight-light mb-4">
                Pengiriman cepat dan produk datang dalam kondisi sempurna.
                Krim wajahnya benar-benar melembapkan tanpa terasa berat —
                recommended banget!
              </h4>
              <img
                class="img-fluid mx-auto mb-3"
